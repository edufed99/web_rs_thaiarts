...
- `backend/app/` FastAPI Private Model Service runtime source (issue #10:
  the public FastAPI application was retired — only `/internal/v1/*`
  authenticated model routes remain)
